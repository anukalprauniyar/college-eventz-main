<%@ Page Title="ViewEventsDetail" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="viewEventImages.aspx.cs" Inherits="CollegeEventz.viewEventImages" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <br />
    <div style="text-align:center">
<center>
           <asp:ListView ID="ListView1" runat="server"  GroupItemCount="2"  style=" border:hidden; padding:inherit; " OnSelectedIndexChanged="ListView1_SelectedIndexChanged1" >
